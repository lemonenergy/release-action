...
var require_package = __commonJS({
  "node_modules/recommended-bump/package.json"(exports, module2) {
    module2.exports = {
...
var require_recommended_bump = __commonJS({
  "node_modules/recommended-bump/index.js"(exports, module2) {
    "use strict";
    var path = require("path");
    var esmLoader = require_esm();
    var pkg = require_package();
    var esmRequire = esmLoader(module2);
    function interop(x) {
...
var import_recommended_bump = __toESM(require_recommended_bump());
...
var bump = async (lastVersion, release, targetPath2 = "") => {
  ...
  const file = (0, import_fs.readFileSync)(`${targetPath2 ? `${targetPath2}/` : ""}package.json`);
